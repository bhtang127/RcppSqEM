require("RcppSqEM") # masked the squarem function
...
# Number of fixed-point evaluations
c(pf2$fpeval, pf3$fpeval, pf4$fpeval, pf5$fpeval)

# Number of objective function evaluations
c(pf2$objfeval, pf3$objfeval, pf4$objfeval, pf5$objfeval)

# Comparison of converged parameter estimates
par.mat <- rbind(pf2$par, pf3$par, pf4$par, pf5$par)
par.mat
