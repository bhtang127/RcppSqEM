...
#####################################EM Algorithm##############################
#####---------------------------------------------------------------###########
em <- fpiter(p = p0, y = y, fixptfn = poissmix.em, objfn = poissmix.loglik,
...
#####---------------------------------------------------------------###########
pureR <- SQUAREM::squarem(p = p0, y = y, fixptfn = poissmix.em, objfn = poissmix.loglik,
               control = list(tol = tol))
pureR
...
###################Squarem to accelerate EM Algorithm##########################
#####---------------------------------------------------------------###########
Rcpp <- RcppSqEM::squarem(p = p0, y = y, fixptfn = poissmix.em, objfn = poissmix.loglik,
                          control = list(tol = tol))
Rcpp
