...
for(i in 1:20){
  ...
  #####---------------------------------------------------------------###########
  mm <- fpiter(par = p0, fixptfn = qmub.update,
                             objfn = binom.loglike,
  ...
  #####---------------------------------------------------------------###########
  pureR <- SQUAREM::squarem(par = p0, fixptfn = qmub.update,
                              objfn = binom.loglike,
                              Z = Z, y = y)
  pureR

  #####---------------------------------------------------------------###########
  #########Squarem to accelerate uniform-bound MM Algorithm (Rcpp)###############
  #####---------------------------------------------------------------###########
  Rcpp <- RcppSqEM::squarem(par = p0, fixptfn = qmvb.update,
                  objfn = binom.loglike,
                  Z = Z, y = y)
