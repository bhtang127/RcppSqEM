...
profvis({
  ...
  #####################################EM Algorithm##############################
  #####---------------------------------------------------------------###########
  em = fpiter(par = param.start, cyy = cyy,
               fixptfn = factor.em,
               objfn = factor.loglik,
  ...
  ##################################ECME Algorithm###############################
  #####---------------------------------------------------------------###########
  ecme = fpiter(par = param.start, cyy = cyy,
  ...
  #####---------------------------------------------------------------###########
  pureR = SQUAREM::squarem(par = param.start, cyy = cyy,
                fixptfn = factor.em,
                objfn = factor.loglik,
                control = list(tol = 10^(-8)))
  pureR
  ...
  #####---------------------------------------------------------------###########
  ###################Rcpp Squarem to accelerate EM Algorithm#####################
  #####---------------------------------------------------------------###########
  Rcpp = RcppSqEM::squarem(par = param.start, cyy = cyy,
                fixptfn = factor.ecme,
                objfn = factor.loglik,
                control = list(tol = 10^(-8)))
  Rcpp
